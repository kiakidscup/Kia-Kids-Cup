document.addEventListener("DOMContentLoaded", function() {
    ...
    <style>
        ...
        .site-logo-desktop {
            ...
            height: 50px;
            width: auto;
            pointer-events: none; /* 將外層改為 none，讓點擊可以穿透到下方的導覽列 */
            opacity: 1;
        ...
        .site-logo-desktop img {
            ...
            pointer-events: auto; /* 將圖片本身設為 auto，確保 Logo 依然可以被點擊回首頁 */
        }
        ...
        /* =========================================================
           桌機版與 RWD 微調 (加上了預留安全距離)
        ========================================================= */

        @media (min-width: 769px) {
            .toolbar-container {
                z-index: 2001;
                /* 預設給予基礎的安全左邊距，並確保不會撐破外框 */
                padding-left: 150px; 
        ...
        @media (min-width: 1201px) {
            /* 大螢幕 Logo 較大，導覽列多退讓一點 */
            .toolbar-container { padding-left: 300px; } 
        ...
        @media (min-width: 1025px) and (max-width: 1200px) {
            /* 中等螢幕的安全距離 */
            .toolbar-container { padding-left: 240px; } 
        ...
        @media (min-width: 769px) and (max-width: 1024px) {
            /* 平板尺寸的安全距離 */
            .toolbar-container { padding-left: 160px; } 
